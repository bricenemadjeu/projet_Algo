    ...
    <div class="row tm-main-row">
            ...
            <div class="inner">
                <nav id="tmMainNav" class="tm-main-nav">
                    <ul>
                        ...
                        <li>
                            <a href="#" class="scrolly active" data-bg-img="comparatif.jpg" data-page="#tm-section-2">
        ...
        <div class="col-xl-9 col-lg-8 col-md-12 col-sm-12 tm-content">
            ...
            <section id="tm-section-2" class="tm-section">
                <div class="ml-auto">
                    <header class="mb-4"><h1 class="tm-text-shadow">Forfaits Mango</h1></header>
                    ...
                    <table id="customers">
                        ...
                        <%
                            ArrayList<Forfait> l = (ArrayList<Forfait>) request.getAttribute("listMango");
                            for (Forfait fo:l){ %>
                        <tr>
...
<script>
    ...
    function changePage(currentNavItem) {
        ...
        $.backstretch("img/comparatif.jpg");
    }
    ...
    $(window).on("load", function(){
        ...
        if(renderPage) {
            ...
            $.backstretch("img/comparatif.jpg", {fade: 500});
